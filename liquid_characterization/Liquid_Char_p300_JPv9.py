...
metadata= { 'ctxname':'Liquid_Characterization p300 JPv9',
            'apiLevel':'2.11',
            'author':'Justin Pickard',
            'source':'Alturas_Analytics',
            'description':'Liquid characterization using p300 pipette'
        }
...
#21ul
    ...
    for well in rowa:
        one_to_one(p300,21,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack2,tuberack2,well)
    for well in rowb:
        one_to_one(p300,21,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack2,tuberack2,well)
#50ul
    for well in rowc:
        one_to_one(p300,50,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack2,tuberack2,well)
    for well in rowd:
        one_to_one(p300,50,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack2,tuberack2,well)
...
#100ul
    for well in rowa:
        one_to_one(p300,100,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack3,tuberack3,well)
    for well in rowb:
        one_to_one(p300,100,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack3,tuberack3,well)
    
#300ul
    for well in rowc:
        one_to_one(p300,300,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack3,tuberack3,well)
    for well in rowd:
        one_to_one(p300,300,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack3,tuberack3,well)
    p300.drop_tip()