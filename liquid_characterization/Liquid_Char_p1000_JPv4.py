...
metadata= { 'ctxname':'Liquid_Characterization p1000 JPv4',
            'apiLevel':'2.11',
            'author':'Justin Pickard',
            'source':'Alturas_Analytics',
            'description':'Liquid characterization using p1000 pipette'
        }
#mix_mix was changed and pip_flow_rate low range volumes now dispense at a higher flow rate
...
#load labware
    ...
    tuberack3 = protocol.load_labware('opentrons_24_tuberack_nest_1.5ml_snapcap','3','tuberack3')
...
#dictionary for volume tracking, put starting volumes in corresponding wells
    ...
    dict_tuberack3={tuberack3['A1']:(0,34), tuberack3['A2']:(0,34), tuberack3['A3']:(0,34),
        tuberack3['A4']:(0,34), tuberack3['A5']:(0,34), tuberack3['A6']:(0,34),
        tuberack3['B1']:(0,34), tuberack3['B2']:(0,34), tuberack3['B3']:(0,34),
        tuberack3['B4']:(0,34), tuberack3['B5']:(0,34), tuberack3['B6']:(0,34),
        tuberack3['C1']:(0,34), tuberack3['C2']:(0,34), tuberack3['C3']:(0,34),
        tuberack3['C4']:(0,34), tuberack3['C5']:(0,34), tuberack3['C6']:(0,34),
        tuberack3['D1']:(0,34), tuberack3['D2']:(0,34), tuberack3['D3']:(0,34),
        tuberack3['D4']:(0,34), tuberack3['D5']:(0,34), tuberack3['D6']:(0,34)
        }
#volume table
...
#100ul
    ...
    for well in rowa:
        one_to_one(p1000,100,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack2,tuberack2,well)
    for well in rowb:
        one_to_one(p1000,100,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack2,tuberack2,well)
...
#250ul
    ...
    for well in rowc:
        one_to_one(p1000,250,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack2,tuberack2,well)
    for well in rowd:
        one_to_one(p1000,250,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack2,tuberack2,well)
...
#500ul
    ...
    for well in rowa:
        one_to_one(p1000,500,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack3,tuberack3,well)
    for well in rowb:
        one_to_one(p1000,500,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack3,tuberack3,well)
    
#1000ul
    for well in rowc:
        one_to_one(p1000,1000,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack3,tuberack3,well)
    for well in rowd:
        one_to_one(p1000,1000,vol_50, dict_tuberack1,tuberack1,'A3',vol_1500,dict_tuberack3,tuberack3,well)
    p1000.drop_tip()