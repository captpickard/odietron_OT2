...
#dictionary for volume tracking, put starting volumes in corresponding wells
    ...
    dict_tuberack2={tuberack2['A1']:(0.0,34), tuberack2['A2']:(0.0,34), tuberack2['A3']:(0.0,34), 
        ...
        tuberack2['D1']:(1500.0,34), tuberack2['D2']:(0.0,34), tuberack2['D3']:(0.0,34), 
    ...
    vol_1500={1500.0: 34, 1400.0: 32, 1300.0: 30, 1200.0: 30,
        1100.0: 28, 1000.0: 28, 900.0: 18, 800.0: 18, 
        700.0: 18, 600.0: 18, 500.0: 18, 400.0: 14, 
        300.0: 14, 200.0:9, 100.0: 7, 90.0: 5, 80.0: 1, 70.0: 1, 
    ...
    p300.pick_up_tip()
    pip_flow_rate(300)
    mix_mix(p300,dict_tuberack2,tuberack2,'D1')
    
    for n in range(13):
        one_to_one(p300,100,vol_1500,dict_tuberack2,tuberack2,'D1',vol_1500,dict_tuberack2,tuberack2,'D2')
        protocol.comment(str(get_volume(dict_tuberack2,tuberack2,'D1')))
        protocol.comment(str(get_height(dict_tuberack2,tuberack2,'D1')))
    for n in range(9):
        one_to_one(p300,20,vol_1500,dict_tuberack2,tuberack2,'D1',vol_1500,dict_tuberack2,tuberack2,'D2')
        protocol.comment(str(get_volume(dict_tuberack2,tuberack2,'D1')))
        protocol.comment(str(get_height(dict_tuberack2,tuberack2,'D1')))
    p300.drop_tip