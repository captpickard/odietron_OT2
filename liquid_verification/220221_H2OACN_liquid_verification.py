...
metadata= { 'ctxname':'Liquid_verification_JPv2',
            'apiLevel':'2.11',
            'author':'Justin Pickard',
            'source':'Alturas_Analytics',
            'description':'Liquid verification using data from liquid characterization'
        }
#updated all code to reflect modules used in serial_dil_JPv4 and API 2.11

def run (protocol: protocol_api.ProtocolContext):
#Change these values according to OT2 protocol writing tool
#save as new file with liquid in title

    vol_p300_low  = 19.08   #default 21.0
    vol_p300_high = 274.40  #default 300.0
    vol_p1000_low = 95.5  #default 101.0
    vol_p1000_high= 930.03  #default 1000.0
